...
return array(
	...
	'Please activate you account go to <a href="{activation_url}">{activation_url}</a>' => 'Для активации аккаунта пожалуйста перейдите по следующей ссылке <a href="{activation_url}">{activation_url}</a>',
    'You have requested the password recovery site {site_name}. To receive a new password, go to <a href="{activation_url}">{activation_url}</a>.'=>'Вы запросили восстановление пароля на сайте {site_name}. Для того, чтобы изменить пароль перейдите по ссылке <a href="{activation_url}">{activation_url}</a>.',
    'You have requested the password recovery site {site_name}'=>'Запрос на смену пароля на сайте {site_name}',
